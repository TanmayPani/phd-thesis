...
%
The words ``atomism'' and  ``atoms'' are etymologically linked to the Greek word \emph{atomos} (indivisible), first used by Democritus in 500 B.C., to denote the most fundamental, indivisible unit of matter. 
%
The atoms of Democritus differed from the matter they came from quantitatively but not qualitatively (an atom of wood would still be an almost infinitesimal piece of wood).\CITETHIS 
%perhaps quickly diverged from the atoms of today as he explained the sweet and bitter tastes as round and jagged atoms going through the tongue. 
%
Meanwhile sometime between 600-200 B.C., the Indian philosopher Kanada developed a non-theistic, atomistic approach to the Vedic texts in the Sanskrit text \emph{Vaishesika Sutra} (Aphorisms on particularity).\CITETHIS
%
Kanada postulated that even the smallest division of any material that still resembles the matter, \emph{Anu} (Sanskrit word for atom) would further comprise of \emph{Paramanu} (Sanskrit for ultimate-atom/sub-atom).
%
Interestingly, Kanada's paramanu were qualitatively different than ordinary matter and were of four kinds, two with mass and two without, and their indivisibility came from their immeasureability.\CITETHIS
%
However, even though they went into concepts like rotational invariance (the paramanu must be spherical to be the same from all directions), the ultimate objective Kanada's sutras had little to do with formalizing natural phenomena and were mostly a metaphysical reading of Vedic teachings like \emph{Dharma}, \emph{Moksha} (Vedic version of the Buddhist \emph{Nirvana}), etc.  
%

Atomism lived on as a niche philosophical concept for the next 2000 years or so, piquing curiosities of thinkers like Aristotle, Epicurius and his Roman descendants, Al-Ghazali and his Ash'ari peers in Basra, Iraq, and eventually in renaissance European philosophers like Galileo and Descartes.
%
In 1704 Issac Newton's \emph{Optika} described the \emph{Corpuscular theory of light}, conceptualizing light as a rectilinear stream of discrete ``corpuscules''  with a finite velocity. 
