...
\begin{equation}
	\frac{d\sigma(P_1, P_2)}{d\mathbf{O}}  = \sum_{i,j,f} \int dx_1dx_2f_i(x_1, \mu^2)f_j(x_2, \mu^2)\frac{d\hat{\sigma}_{ij\to f}(p_1, p_2, \alpha_s, Q^2/\mu^2)}{d\hat{\mathbf{O}}}D_f(\hat{\mathbf{O}}\to\mathbf{O}, \mu^2)
