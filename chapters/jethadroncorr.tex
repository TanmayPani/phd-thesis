...
\begin{figure}
	...
	\caption{Example of a correlation function distribution in 2 dimensions between \pttrigrange{15}{20} \ptassocrange{1.0}{1.5} (left). Example of a normalized mixed event distribution in 2 dimensions between \pttrigrange{15}{20} \ptassocrange{1.0}{1.5} showing the \(\Delta\eta = \eta_\mathrm{jet} - \eta_\mathrm{assoc.}\) acceptance for associated particles given \(|\eta_\mathrm{assoc.}| < 1.0 \) and \(|\eta_\mathrm{jet}| < 0.6 \) (right).}
