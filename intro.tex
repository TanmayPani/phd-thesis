...
\begin{table}[htbp]
	\begin{tabular}{>{\centering\arraybackslash}m{4.5cm} >{\centering\arraybackslash}m{4.5cm} >{\centering\arraybackslash}m{4.5cm}}
		...
		\multicolumn{3}{l}{\vhead{Strong Vertices}}                                                         \\[0.1cm]
		\threevertex{fermion}{q}{fermion}{q}{gluon}{g}                                                    &
		\threevertex{gluon}{g}{gluon}{g}{gluon}{g}                                                        &
		\fourvertex{gluon}{g}{gluon}{g}{gluon}{g}{gluon}{g}                                                 \\[1cm]

		% ROW 2: Weak Vertices
		\multicolumn{3}{l}{\vhead{Weak Vertices}}                                                           \\[0.1cm]
		\threevertex{fermion}{f}{fermion}{f}{photon}{Z}                                                   &
		\threevertex{fermion}{\nu_e \mid \nu_\mu \mid \nu_\tau}{fermion}{e \mid \mu \mid \tau}{photon}{W} &
		\threevertex{fermion}{d/s/b}{fermion}{u/c/t}{photon}{W}                                             \\[1cm]

		% ROW 3: Electromagnetic and Electroweak Vertices
		\multicolumn{1}{l}{\vhead{Electromagnetic Vertex}}                                                &
		\multicolumn{2}{l}{\vhead{Electroweak Vertices}}                                                    \\[0.1cm]
		\threevertex{fermion}{X^{+|-}}{fermion}{X^{-|+}}{photon}{\gamma}                                  &
		\threevertex{photon}{Z/\gamma}{photon}{W}{photon}{W}                                              &
		\fourvertex{photon}{W}{photon}{W}{photon}{W|Z/\gamma}{photon}{W|Z/\gamma}                           \\[1cm]

		% ROW 4: Higgs Vertices
		\multicolumn{3}{l}{\vhead{Higgs Vertices}}                                                          \\[0.1cm]
