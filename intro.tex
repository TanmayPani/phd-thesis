...
Where,
\begin{align}
	t = \ln{\frac{Q^2}{\mu^2}}, &\quad \beta(\alpha_s) = \mu^2\frac{\partial\alpha_s}{\partial\mu^2},\quad\alpha_s\equiv\alpha_s(\mu^2(t)) \notag\\
	\implies \beta(\alpha_s) &= -\frac{\partial\alpha_s}{\partial t}\notag\\
...
\begin{align}
	t  &= \int^{\alpha_s(Q^2)}_{\alpha_s}\frac{d\alpha_s}{\beta(\alpha_s)}
...
Typically, \(\Lambda \sim 200\mathrm{MeV}\) with small variations depending on its exact definition. This behaviour leads to:
\begin{itemize}
